        ...
        return (
            <Form onSubmit={(e) => this.handleSubmit(e)}>
                ...
                <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control type="text" value={this.contact.firstName} onChange={this.handleChange} propname="firstName" />
                ...
                <div className="row">
                    ...
                    <div className="col-6"><input type="text" className="FormControl" /></div>
                </div>
                <div className="row">
